...
export const APP_TAGLINE = "Rejoignez un groupe ou proposez votre abo. Économisez, rentabilisez.";
export const APP_DESCRIPTION =
  "Au Sénégal, au Congo et au Gabon : payez moins en rejoignant un abonnement partagé, ou ajoutez le vôtre et rentabilisez les places libres — paiements locaux, escrow et profils vérifiés.";
...
export const ROUTES = {
  ...
  SUBSCRIPTION_DETAIL: (id: string) => `/abonnements/${id}`,
  CREATE_SUBSCRIPTION: "/abonnements/creer",
  PROFILE: "/profil",
  SETTINGS: "/parametres",
  CHECKOUT: (id: string) => `/checkout/${id}`,
  MESSAGES: (subscriptionId: string) => `/messages/${subscriptionId}`,
} as const;
